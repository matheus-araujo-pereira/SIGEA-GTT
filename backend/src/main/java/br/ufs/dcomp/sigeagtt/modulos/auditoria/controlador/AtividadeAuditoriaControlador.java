...
import br.ufs.dcomp.sigeagtt.modulos.auditoria.servico.AtividadeAuditoriaServico;
...
public class AtividadeAuditoriaControlador {

    private final AtividadeAuditoriaServico servico;

    public AtividadeAuditoriaControlador(AtividadeAuditoriaServico servico) {
