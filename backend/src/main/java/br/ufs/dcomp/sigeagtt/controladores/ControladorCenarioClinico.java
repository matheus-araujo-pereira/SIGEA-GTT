...
import br.ufs.dcomp.sigeagtt.servicos.CenarioClinicoServico;
...
public class ControladorCenarioClinico {

    private final CenarioClinicoServico servico;

    public ControladorCenarioClinico(CenarioClinicoServico servico) {
