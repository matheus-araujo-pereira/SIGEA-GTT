...
import br.ufs.dcomp.sigeagtt.repositorios.TurmaAlunoRepositorio;
...
public class TurmaServico {
    ...
    public List<TurmaRespostaDTO> listar(Long professorId) {
        List<Turma> turmas = (professorId != null)
    ...
    public void desmatricularAluno(Long turmaId, Long alunoId) {
        if (!turmaAlunoRepositorio.existsByTurmaIdAndAlunoId(turmaId, alunoId)) {
            throw new IllegalArgumentException("O aluno informado não está vinculado a esta turma.");
        }
