...
public record SubmissaoDTO(
    ...
    public static SubmissaoDTO deEntidade(
        ...
        return new SubmissaoDTO(
            ...
            s.getAtividade() != null && s.getAtividade().getTurma() != null ? s.getAtividade().getTurma().getNomeDisciplina() : null,
            s.getAtividade() != null && s.getAtividade().getTurma() != null && s.getAtividade().getTurma().getProfessorResponsavel() != null
                ? s.getAtividade().getTurma().getProfessorResponsavel().getNomeCompleto() : null,
            s.getAtividade() != null ? s.getAtividade().getTempoLimiteMinutos() : 20,
            s.getAtividade() != null && s.getAtividade().getCasoClinico() != null
                ? CasoClinicoDTO.deEntidade(s.getAtividade().getCasoClinico()) : null,
