package br.ufs.dcomp.sigeagtt.nucleo.excecoes;
...
public class ManipuladorExcecoesGlobal {
    ...
    private Map<String, Object> construirCorpo(
            HttpStatus status, String erro, String mensagem, Map<String, String> campos) {
    ...
    public ResponseEntity<Map<String, Object>> tratarIntegridadeDados(
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(
                        construirCorpo(
                                ...
                                "Registro duplicado ou operação viola integridade referencial.",
                                null));
    }

    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<Map<String, Object>> tratarMensagemIlegivel(
    ...
    public ResponseEntity<Map<String, Object>> tratarValidacoesCampos(
